 ...
 * from a Controllable in the World's simulator, to the client (that is, 
 * an Environment/Agent pair) that will control that Controllable during the 
 * execution of the simulator.  The controllable name should be a String that
 * uniquely identifies the Controllable through a call to getName(), and the 
 * target client location should be the xml file for a ClientInitializer.
 * 
