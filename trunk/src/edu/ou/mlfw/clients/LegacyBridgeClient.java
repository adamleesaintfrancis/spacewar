...
public class LegacyBridgeClient implements Client, Drawer {
	...
	public void initialize(File config) {
		try {
			logger.debug("Loading ClientInitializer for " + config + "...\n");
		...
		throws InstantiationException, IllegalAccessException 
	{
		...
		logger.debug("Instantiating client environment ("
		...
		logger.debug("Initializing client environment ("
